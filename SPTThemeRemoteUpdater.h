...
@interface SPTThemeRemoteUpdater : NSObject <MCBrowserViewControllerDelegate, MCSessionDelegate>
{
    ...
    int _currentType;
    unsigned int _expectedMessageType;
    MCSession *_session;
}

+ (int)themePropertyFromString:(id)arg1;
@property(retain, nonatomic) MCSession *session; // @synthesize session=_session;
@property(nonatomic) unsigned int expectedMessageType; // @synthesize expectedMessageType=_expectedMessageType;
