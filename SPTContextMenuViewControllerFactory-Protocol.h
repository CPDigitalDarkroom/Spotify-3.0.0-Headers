...
- (SPTContextMenuViewController *)provideContextMenuViewControllerWithHeaderImageURL:(NSURL *)arg1 headerImagePlaceholder:(UIImage *)arg2 imageStyle:(unsigned int)arg3 title:(NSString *)arg4 subtitle:(NSString *)arg5 metadataTitle:(NSString *)arg6 tasks:(NSArray *)arg7 entityURL:(NSURL *)arg8;
...
- (SPTContextMenuViewController *)provideContextMenuViewControllerWithHeaderImageURL:(NSURL *)arg1 headerImagePlaceholder:(UIImage *)arg2 imageStyle:(unsigned int)arg3 title:(NSString *)arg4 subtitle:(NSString *)arg5 metadataTitle:(NSString *)arg6 actions:(NSArray *)arg7 entityURL:(NSURL *)arg8;
