...
- (void)preloadAlbumViewData:(unsigned int)arg1 forArtist:(NSURL *)arg2 usingResolver:(id <SPTResolver>)arg3;
- (void)preloadAlbumViewData:(unsigned int)arg1 forArtist:(NSURL *)arg2;
