...
@property(readonly, nonatomic) unsigned int serviceVersion; // @synthesize serviceVersion=_serviceVersion;
...
- (id)initWithApolloDataLoader:(id)arg1 serviceVersion:(unsigned int)arg2;
