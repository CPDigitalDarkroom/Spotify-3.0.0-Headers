...
- (void)adEntityViewModel:(SPTAdEntityViewModel *)arg1 playerItemFailed:(BOOL)arg2;
...
- (void)adEntityViewModel:(SPTAdEntityViewModel *)arg1 didTimeOut:(BOOL)arg2;
- (void)adEntityViewModel:(SPTAdEntityViewModel *)arg1 didFinishPlaying:(BOOL)arg2;
@end
