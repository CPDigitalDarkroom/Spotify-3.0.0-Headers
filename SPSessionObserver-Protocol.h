...
@class NSError, NSString, NSURL, SPPlayTrackCommand, SPSession;

@protocol SPSessionObserver <NSObject>

@optional
- (void)sessionScrobblingError:(SPSession *)arg1;
- (void)session:(SPSession *)arg1 socialChange:(int)arg2 description:(NSString *)arg3;
- (void)session:(SPSession *)arg1 socialError:(NSError *)arg2;
- (void)session:(SPSession *)arg1 incognitoModeChangedByTimeout:(BOOL)arg2;
- (void)session:(SPSession *)arg1 playTrackCommand:(SPPlayTrackCommand *)arg2;
