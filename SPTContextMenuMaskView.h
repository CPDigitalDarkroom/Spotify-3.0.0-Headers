...
@property(nonatomic) float bottomMaskHeight; // @synthesize bottomMaskHeight=_bottomMaskHeight;
@property(nonatomic) float topMaskHeight; // @synthesize topMaskHeight=_topMaskHeight;
- (void).cxx_destruct;
- (void)layoutSubviews;
