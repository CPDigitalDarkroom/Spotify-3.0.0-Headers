...
@class NSRunLoop, NSString, NSThread, NSTimer, PlayController, SPApHermesController, SPSession, SPTConnectivityManager, SPTCoreCreateOptions, SPTEntityService, SPTOfflineManager, SPTSocialManager;
...
@property(retain, nonatomic) PlayController *playController; // @synthesize playController=_playController;
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) BOOL forcedOffline;
...
- (void)flushAllCaches;
- (void)flushCaches;
- (void)setRememberMeModeForUsername:(id)arg1 rememberMe:(BOOL)arg2;
