...
@interface SPTLogMessageUIImpression1 : SPTLogMessage
{
...
+ (id)messageWithRequestId:(id)arg1 featureId:(id)arg2 pageId:(id)arg3 sectionId:(id)arg4 rowIndex:(long long)arg5 columnIndex:(long long)arg6 targetUri:(id)arg7 impressionType:(id)arg8 msSinceEpoch:(long long)arg9;
