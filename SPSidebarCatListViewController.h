...
@class NSArray, NSString, SPKVObservation, SPTProfileInvitesCountControl, SPTSidebarInboxControl, SPTSidebarMaskedView, SPTSidebarProfileControl, SPTSidebarSettingsControl, SPUser, UITableView, UIView;
