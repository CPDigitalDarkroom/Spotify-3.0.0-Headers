...
{
    struct shared_ptr<SPTPlaylistHolder> _playlist_holder;
    BOOL _collaborative;
    BOOL _isWriteable;
    BOOL _isOwnedBySelf;
    NSString *_name;
...
@property(readonly, nonatomic) int revisionCount; // @synthesize revisionCount=_revisionCount;
...
@property(readonly, nonatomic) BOOL isOwnedBySelf; // @synthesize isOwnedBySelf=_isOwnedBySelf;
@property(readonly, nonatomic) BOOL isWriteable; // @synthesize isWriteable=_isWriteable;
...
- (void).cxx_destruct;
- (void)dealloc;
- (id)initOnCoreThreadWithPlaylist:(PassRefPtr_687b826e)arg1 withLoadedHandler:(id)arg2;
...
- (void)triggerUpdate;
- (void)removeTrackAtIndex:(unsigned int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)appendTracks:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)addTracks:(id)arg1 atIndex:(unsigned int)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)addTrack:(id)arg1 atIndex:(unsigned int)arg2 completionHandler:(CDUnknownBlockType)arg3;
