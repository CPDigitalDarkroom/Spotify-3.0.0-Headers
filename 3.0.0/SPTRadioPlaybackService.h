...
@interface SPTRadioPlaybackService : NSObject <SPTPlayerObserver>
{
...
- (void)setFeedbackForTrackURL:(id)arg1 thumbs:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)broadcastPlaybackStateChanged:(unsigned int)arg1;
...
- (void)startRadioStation:(id)arg1 startedFromElement:(id)arg2 atIndex:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)startRadioStation:(id)arg1 startedFromElement:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)startDecoratedRadioStation:(id)arg1 startedFromElement:(id)arg2 atIndex:(int)arg3 completion:(CDUnknownBlockType)arg4;
