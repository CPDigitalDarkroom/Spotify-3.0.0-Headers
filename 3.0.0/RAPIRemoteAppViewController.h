...
- (void)displayErrorMessage:(id)arg1 forScreen:(int)arg2;
...
- (void)masterOptionButtonPressedForListScreen:(int)arg1;
...
- (void)checkbox:(id)arg1 didChangeCheckedValue:(BOOL)arg2;
