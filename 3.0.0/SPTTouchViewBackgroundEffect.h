...
@property(nonatomic) BOOL ending; // @synthesize ending=_ending;
...
- (void)setBackgroundColorForSample:(id)arg1 volume:(float)arg2 animated:(BOOL)arg3;
- (void)updateNodes:(id)arg1 position:(struct CGPoint)arg2 viewEngine:(id)arg3 shouldInitializeNodes:(BOOL)arg4;
