...
@class NSHashTable, NSString, SPTNowPlayingAuxiliaryActionsModel, SPTNowPlayingEntityDecorationController, SPTNowPlayingPlaybackController, SPTNowPlayingQueueMetadataModel, SPTNowPlayingRadioThumbsStateManager, SPTNowPlayingTrackMetadataQueue, SPTNowPlayingTrackPosition, SPTPlayerProvidedTrack, SPTStatefulPlayer;
