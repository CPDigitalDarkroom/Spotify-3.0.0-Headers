...
@class NSHashTable, SPTLogCenter, SPTNowPlayingBlurControllerObject, SPTNowPlayingModel, SPTTheme;
...
- (void)createCarouselUnit;
- (void)processPlayerStateChange:(id)arg1;
- (id)initWithPlayer:(id)arg1 model:(id)arg2 imageLoaderFactory:(id)arg3 theme:(id)arg4 logCenter:(id)arg5 upsellPopupManager:(id)arg6 runningTestManager:(id)arg7 runningPlaybackManager:(id)arg8 videoSurfaceManager:(id)arg9;
