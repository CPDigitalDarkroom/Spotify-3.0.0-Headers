...
+ (id)legacyShareItemTypeStringForShareType:(unsigned int)arg1;
...
+ (id)shareDescriptionWithShareType:(unsigned int)arg1 itemName:(id)arg2 creatorName:(id)arg3 sourceName:(id)arg4;
