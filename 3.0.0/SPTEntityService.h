...
- (BOOL)taskWasCancelled:(struct MetadataTask *)arg1;
...
- (id)lookupArtists:(const Array_d2b128ec *)arg1 decorated:(BOOL)arg2 callback:(CDUnknownBlockType)arg3;
- (id)lookupAlbums:(const Array_d2b128ec *)arg1 decorated:(BOOL)arg2 callback:(CDUnknownBlockType)arg3;
- (id)lookupTracks:(const Array_d2b128ec *)arg1 decorated:(BOOL)arg2 callback:(CDUnknownBlockType)arg3;
- (id)getEntitiesFromCache:(id)arg1 withLinks:(const Array_d2b128ec *)arg2;
- (id)lookupEntitesWithURLs:(id)arg1 decorated:(BOOL)arg2 callback:(CDUnknownBlockType)arg3;
