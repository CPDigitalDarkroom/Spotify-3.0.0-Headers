...
@interface SPTAppLinkBrowseCommand : SPTAppLinkExternalContentPresentation <SPTAppLinkCommand>
{
    id <SPTAppLinkCommandDelegate> delegate;
    id <SPTExternalContentItem> _browseItem;
}

@property(retain, nonatomic) id <SPTExternalContentItem> browseItem; // @synthesize browseItem=_browseItem;
