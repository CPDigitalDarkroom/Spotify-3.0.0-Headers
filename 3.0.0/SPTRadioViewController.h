...
{
    BOOL _isPaused;
    BOOL _ignoreNextModelUpdate;
    BOOL _firstTimeReceivingData;
...
@property(nonatomic) BOOL firstTimeReceivingData; // @synthesize firstTimeReceivingData=_firstTimeReceivingData;
@property(nonatomic) BOOL ignoreNextModelUpdate; // @synthesize ignoreNextModelUpdate=_ignoreNextModelUpdate;
...
- (void)radioViewModel:(id)arg1 offlineStateUpdated:(BOOL)arg2;
...
- (void)radioViewModel:(id)arg1 stationDidStartPlaying:(id)arg2 paused:(BOOL)arg3;
