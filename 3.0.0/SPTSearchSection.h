...
{
    BOOL _containsInteractiveEntities;
    NSString *_identifier;
    NSString *_title;
    NSString *_allResultsTitle;
    NSURL *_allResultsViewURL;
    NSString *_allResultsViewTitle;
    unsigned int _entityRenderingStyle;
    NSOrderedSet *_entities;
}

@property(readonly, nonatomic) NSOrderedSet *entities; // @synthesize entities=_entities;
@property(readonly, nonatomic) unsigned int entityRenderingStyle; // @synthesize entityRenderingStyle=_entityRenderingStyle;
@property(readonly, nonatomic) BOOL containsInteractiveEntities; // @synthesize containsInteractiveEntities=_containsInteractiveEntities;
...
- (id)initWithIdentifier:(id)arg1 entities:(id)arg2 title:(id)arg3 allResultsTitle:(id)arg4 allResultsViewURL:(id)arg5 allResultsViewTitle:(id)arg6 entityRenderingStyle:(unsigned int)arg7;
