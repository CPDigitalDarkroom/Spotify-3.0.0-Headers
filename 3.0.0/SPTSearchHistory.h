...
- (void)synchronize;
- (void)clear;
- (void)removeSearchStringAtIndex:(unsigned int)arg1;
- (void)addSearchStringToHistory:(id)arg1;
- (id)searchStringAtIndex:(unsigned int)arg1;
@property(readonly, nonatomic) unsigned int numberOfSavedSearchStrings;
