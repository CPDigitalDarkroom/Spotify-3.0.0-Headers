...
- (id)image;
- (id)title;
- (id)initWithItemURL:(id)arg1 itemName:(id)arg2 creatorName:(id)arg3 sourceName:(id)arg4 imageURL:(id)arg5 shareType:(unsigned int)arg6 session:(id)arg7 shareFeature:(id)arg8 logContext:(id)arg9;
