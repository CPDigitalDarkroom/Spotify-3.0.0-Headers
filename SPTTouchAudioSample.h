...
@interface SPTTouchAudioSample : NSObject <SPTTouchPreviewChannelDelegate>
{
    ...
    unsigned int _minimumNumberOfBytes;
...
@property(nonatomic) unsigned int minimumNumberOfBytes; // @synthesize minimumNumberOfBytes=_minimumNumberOfBytes;
...
- (BOOL)internalSetVolume:(float)arg1;
- (void)removeObserver:(id)arg1;
- (void)addObserver:(id)arg1 on:(id)arg2;
- (void)preload;
- (void)setVolume:(float)arg1 fadeDuration:(double)arg2;
@property(nonatomic) float volume;
- (id)initWithURL:(id)arg1 download:(id)arg2 preloadByteSize:(unsigned int)arg3 audioDriverController:(id)arg4;
