...
{
    BOOL _disableFilterBar;
    BOOL _viewHasAppeared;
    BOOL _shouldReloadWhenAppearing;
    BOOL _userDefaultsLoaded;
    BOOL _collectionRecentlyPlayedLayout;
    ...
    unsigned int _numberOfSyncProgressViews;
...
@property(nonatomic) BOOL collectionRecentlyPlayedLayout; // @synthesize collectionRecentlyPlayedLayout=_collectionRecentlyPlayedLayout;
...
@property(nonatomic) unsigned int numberOfSyncProgressViews; // @synthesize numberOfSyncProgressViews=_numberOfSyncProgressViews;
...
@property(nonatomic) BOOL shouldReloadWhenAppearing; // @synthesize shouldReloadWhenAppearing=_shouldReloadWhenAppearing;
...
@property(nonatomic) BOOL disableFilterBar; // @synthesize disableFilterBar=_disableFilterBar;
...
- (void)swipeableTableViewCell:(id)arg1 didCompleteGesture:(unsigned int)arg2;
...
- (void)updateSubtitleOfflineAccessoryViewInCell:(id)arg1 forStatus:(unsigned int)arg2;
- (void)updateOfflineAccessoryButtonInCell:(id)arg1 forStatus:(unsigned int)arg2;
- (void)updateOfflineStatus:(unsigned int)arg1 forCell:(id)arg2;
- (void)applyThemeLayout;
- (void)dealloc;
- (void)sessionLoginModeChanged:(id)arg1;
- (id)initWithSession:(id)arg1 offlineManager:(id)arg2 container:(id)arg3 audioTouch:(id)arg4 uri:(id)arg5 syncProgressController:(id)arg6 localSettings:(id)arg7 imageLoaderFactory:(id)arg8 iTunesLibraryManager:(id)arg9 collectionRecentlyPlayedLayout:(BOOL)arg10 offlineModeNotifier:(id)arg11;
