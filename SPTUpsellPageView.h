...
- (void).cxx_destruct;
- (void)applyRoundedCornersToHeaderLabel;
- (void)applyThemeLayout;
- (void)addWidthConstraintToView:(id)arg1 withConstant:(float)arg2;
- (void)addHeightConstraintToView:(id)arg1 withConstant:(float)arg2;
- (void)addTopConstraintForView:(id)arg1 withConstant:(float)arg2;
- (void)centerHorizontaly:(id)arg1;
- (void)updateConstraints;
- (struct CGRect)textSizeOfLabel:(id)arg1 constrainedToSize:(struct CGSize)arg2;
- (float)recalculateSubtitleHeight;
- (float)recalculateTitleHeight;
- (BOOL)contentFits;
