...
{
    BOOL _shouldDisableLeftBarButton;
...
@property(nonatomic) BOOL shouldDisableLeftBarButton; // @synthesize shouldDisableLeftBarButton=_shouldDisableLeftBarButton;
...
- (void).cxx_destruct;
- (void)disableNavigationBarMinimization:(BOOL)arg1;
