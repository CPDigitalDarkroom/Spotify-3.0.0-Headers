...
{
    BOOL _thumbsInProgress;
    NSHashTable *_observers;
    SPTStatefulPlayer *_player;
    SPTNowPlayingRadioThumbsStateManager *_radioThumbsStateManager;
}

@property(nonatomic) BOOL thumbsInProgress; // @synthesize thumbsInProgress=_thumbsInProgress;
...
@property(readonly, nonatomic) BOOL disallowSeekingAlways;
