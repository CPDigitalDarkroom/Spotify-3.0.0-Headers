...
@interface SPTAppLinkChooseRadioCommand : SPTAppLinkExternalContentPresentation <SPTAppLinkCommand>
{
    id <SPTAppLinkCommandDelegate> delegate;
    id <SPTExternalContentItem> _radioItem;
}

@property(retain, nonatomic) id <SPTExternalContentItem> radioItem; // @synthesize radioItem=_radioItem;
