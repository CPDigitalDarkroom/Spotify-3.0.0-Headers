...
@interface SPTAccountUpsellViewController : UITableViewController <SPTNavigationControllerNavigationBarState, SPTAccountUpsellViewModelDelegate, SPTAccountErrorDialogDelegate>
{
...
- (id)cellIdentifierForType:(unsigned int)arg1;
