...
@property(nonatomic) float lastHeaderHeight; // @synthesize lastHeaderHeight=_lastHeaderHeight;
@property(nonatomic) float contextMenuHeaderPreferredHeight; // @synthesize contextMenuHeaderPreferredHeight=_contextMenuHeaderPreferredHeight;
...
@property(nonatomic) unsigned int contextMenuSubtitleStyle;
...
- (void)loadView;
- (void)dealloc;
- (id)initWithHeaderImageURL:(id)arg1 headerImagePlaceholder:(id)arg2 imageStyle:(unsigned int)arg3 title:(id)arg4 subtitle:(id)arg5 metadataTitle:(id)arg6 tasks:(id)arg7 entityURL:(id)arg8 imageLoader:(id)arg9;
...
- (id)initWithHeaderImageURL:(id)arg1 headerImagePlaceholder:(id)arg2 imageStyle:(unsigned int)arg3 title:(id)arg4 subtitle:(id)arg5 metadataTitle:(id)arg6 actions:(id)arg7 entityURL:(id)arg8 imageLoader:(id)arg9;
...
- (id)initWithHeaderImageURL:(id)arg1 headerImagePlaceholder:(id)arg2 imageStyle:(unsigned int)arg3 title:(id)arg4 subtitle:(id)arg5 metadataTitle:(id)arg6 entityURL:(id)arg7 imageLoader:(id)arg8;
...
@property(retain, nonatomic) SPTContextMenuView *view;
