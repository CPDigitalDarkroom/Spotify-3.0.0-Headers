...
{
    unsigned int _totalEnqueuedPacketLength;
...
@property unsigned int totalEnqueuedPacketLength; // @synthesize totalEnqueuedPacketLength=_totalEnqueuedPacketLength;
- (void).cxx_destruct;
- (id)queueForDequeueingPacket;
- (id)queueForEnqueueingPacket:(BOOL)arg1;
- (id)description;
- (id)dequeue;
