...
@interface FBAppEvents : NSObject
{
    ...
    _Bool _shouldAccessAdvertisingID;
    _Bool _doesAppLogImplicitPurchaseEvents;
...
@property _Bool doesAppLogImplicitPurchaseEvents; // @synthesize doesAppLogImplicitPurchaseEvents=_doesAppLogImplicitPurchaseEvents;
@property _Bool shouldAccessAdvertisingID; // @synthesize shouldAccessAdvertisingID=_shouldAccessAdvertisingID;
@property _Bool appSupportsImplicitLogging; // @synthesize appSupportsImplicitLogging=_appSupportsImplicitLogging;
@property unsigned long long appSettingsFetchState; // @synthesize appSettingsFetchState=_appSettingsFetchState;
