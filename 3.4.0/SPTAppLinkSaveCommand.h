...
@interface SPTAppLinkSaveCommand : NSObject <SPTAppLinkCommand>
{
    _Bool _saveStateAtLastAdded;
    id <SPTAppLinkCommandDelegate> delegate;
    SPTExternalPlaybackControl *_playControl;
}

@property(nonatomic) _Bool saveStateAtLastAdded; // @synthesize saveStateAtLastAdded=_saveStateAtLastAdded;
