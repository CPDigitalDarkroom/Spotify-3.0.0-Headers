...
@interface SPTProgressView : UIView <SPTThemableView>
{
    ...
    unsigned long long _customIcon;
...
+ (id)progressView;
@property _Bool loadingViewShown; // @synthesize loadingViewShown=_loadingViewShown;
@property(retain, nonatomic) UILabel *titleLabel; // @synthesize titleLabel=_titleLabel;
@property(retain, nonatomic) UIView *indicatorView; // @synthesize indicatorView=_indicatorView;
@property(retain, nonatomic) UIView *containerView; // @synthesize containerView=_containerView;
@property(nonatomic) unsigned long long customIcon; // @synthesize customIcon=_customIcon;
