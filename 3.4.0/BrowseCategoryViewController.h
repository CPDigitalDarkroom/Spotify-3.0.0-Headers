...
{
    _Bool _shouldRenderPlaybuttonsForNewReleases;
    _Bool _showPlayTopSongsButton;
...
@property(nonatomic) _Bool showPlayTopSongsButton; // @synthesize showPlayTopSongsButton=_showPlayTopSongsButton;
...
@property(nonatomic) _Bool shouldRenderPlaybuttonsForNewReleases; // @synthesize shouldRenderPlaybuttonsForNewReleases=_shouldRenderPlaybuttonsForNewReleases;
...
- (_Bool)itemIsSocialChart:(id)arg1;
...
- (void)browseCollectionViewDidApplyNewFilter:(id)arg1 withRow:(long long)arg2;
- (id)filterButtonTitle;
- (id)categoryAndSubTitle;
- (id)subcategoryTitle;
- (long long)browseCollectionViewCurrentFilterRow:(id)arg1;
- (id)viewEventURI;
