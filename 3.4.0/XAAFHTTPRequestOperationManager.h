...
@class NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSURL, NSURLCredential, XAAFHTTPRequestSerializer<XAAFURLRequestSerialization>, XAAFHTTPResponseSerializer<AFURLResponseSerialization>, XAAFNetworkReachabilityManager, XAAFSecurityPolicy;
...
@property(retain, nonatomic) XAAFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) XAAFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
...
@property(retain, nonatomic) XAAFHTTPResponseSerializer<AFURLResponseSerialization> *responseSerializer; // @synthesize responseSerializer=_responseSerializer;
@property(retain, nonatomic) XAAFHTTPRequestSerializer<XAAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
