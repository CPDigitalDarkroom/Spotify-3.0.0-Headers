...
- (void)loadImageForRelativeIndex:(long long)arg1;
...
- (void)handleSkipToPreviousWithBehavior:(unsigned long long)arg1 dragging:(_Bool)arg2;
- (void)handleSkipToNextWithBehavior:(unsigned long long)arg1 dragging:(_Bool)arg2;
