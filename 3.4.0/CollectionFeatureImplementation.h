...
- (void)registerCollectionContentListWithTitle:(id)arg1 icon:(unsigned long long)arg2 URL:(id)arg3 order:(unsigned long long)arg4;
...
- (id)playerForViewURI:(id)arg1 referrerIdentifier:(id)arg2;
- (id)playerForViewURI:(id)arg1;
- (id)trackContextPlayerForViewURI:(id)arg1 referrerIdentifier:(id)arg2;
