...
@class GaiaMessageBarController, MessageBarAlertItem, NSArray, NSString, SPTGaiaDevice, SPTGaiaDeviceManager;
...
@property(retain, nonatomic) MessageBarAlertItem *grabbedMessageBarAlertItem; // @synthesize grabbedMessageBarAlertItem=_grabbedMessageBarAlertItem;
@property(retain, nonatomic) SPTGaiaDevice *lastDevice; // @synthesize lastDevice=_lastDevice;
