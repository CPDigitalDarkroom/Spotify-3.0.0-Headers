...
{
    _Bool _shouldShowHeaderViewSeparator;
...
@property(nonatomic) _Bool shouldShowHeaderViewSeparator; // @synthesize shouldShowHeaderViewSeparator=_shouldShowHeaderViewSeparator;
