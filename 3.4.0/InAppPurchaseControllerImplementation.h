...
- (void)handlePaymentVerification:(id)arg1 error:(id)arg2 showLoading:(_Bool)arg3;
- (void)verifyTransactionReceipt:(id)arg1 showLoading:(_Bool)arg2;
...
- (void)clearSettings;
- (void)dealloc;
- (id)initWithSession:(id)arg1 hermes:(id)arg2 localSettings:(id)arg3 productState:(id)arg4 productStateMonitorController:(id)arg5 trialController:(id)arg6 logCenter:(id)arg7 dataLoader:(id)arg8 httpTestManager:(id)arg9;
