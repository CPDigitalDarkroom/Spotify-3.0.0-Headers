...
@interface SPTAppLinkChooseArtistCommand : SPTAppLinkExternalContentPresentation <SPTAppLinkCommand>
{
    id <SPTAppLinkCommandDelegate> delegate;
    id <SPTExternalContentItem> _artistsAlbum;
}

@property(retain, nonatomic) id <SPTExternalContentItem> artistsAlbum; // @synthesize artistsAlbum=_artistsAlbum;
...
- (id)initWithArtistsItem:(id)arg1;
