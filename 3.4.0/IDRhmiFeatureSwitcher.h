...
{
    _Bool _didUpdateAppInfosInCurrentConnectionCycle;
...
@property _Bool didUpdateAppInfosInCurrentConnectionCycle; // @synthesize didUpdateAppInfosInCurrentConnectionCycle=_didUpdateAppInfosInCurrentConnectionCycle;
...
- (_Bool)updateShortAppInfosOnEveryConnectionCycle;
