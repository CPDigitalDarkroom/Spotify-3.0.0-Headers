...
@class NSString, SPTLayoutConstraintBuilder, SPTNowPlayingBaseHeadUnitView, SPTNowPlayingDurationView, SPTNowPlayingFullScreenVideoControlsConstraints, SPTNowPlayingNavigationBarView, SPTNowPlayingVideoFooterView, SPTNowPlayingVideoHeaderView, SPTTheme, UIActivityIndicatorView, UIView<SPTVideoSurface>;
