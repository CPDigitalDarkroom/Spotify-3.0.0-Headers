...
@class NSArray, NSDate, NSDictionary, NSString, NSURL, SPTPlayOrigin, SPTPlayerNumericIndex, SPTPlayerOptions, SPTPlayerRestrictions, SPTPlayerSuppressions, SPTPlayerTrack;
