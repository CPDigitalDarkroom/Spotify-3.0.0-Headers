...
{
    _Bool _alwaysCollapsed;
    NSURL *_imageURL;
    unsigned long long _buttonIcon;
...
@property(nonatomic, getter=isAlwaysCollapsed) _Bool alwaysCollapsed; // @synthesize alwaysCollapsed=_alwaysCollapsed;
@property(copy, nonatomic) NSURL *buttonPlaybackURL; // @synthesize buttonPlaybackURL=_buttonPlaybackURL;
@property(copy, nonatomic) NSString *buttonTitle; // @synthesize buttonTitle=_buttonTitle;
@property(nonatomic) unsigned long long buttonIcon; // @synthesize buttonIcon=_buttonIcon;
