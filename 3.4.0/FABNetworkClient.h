...
+ (void)startDownloadTaskForSession:(id)arg1 withRequest:(id)arg2 retryCount:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;
+ (void)startDataTaskForSession:(id)arg1 withRequest:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
+ (void)startDataTaskForSession:(id)arg1 withRequest:(id)arg2 retryCount:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;
