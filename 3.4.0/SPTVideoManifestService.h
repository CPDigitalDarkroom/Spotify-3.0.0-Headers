...
@class NSMapTable, NSOperationQueue, NSString, SPTDataLoaderFactory, SPTPersistentDataCache, SPTVideoPreferences, SPTVideoSegmentProxy;
...
- (id)initWithDataLoaderFactory:(id)arg1 segmentProxy:(id)arg2 cache:(id)arg3 videoPreferences:(id)arg4;
