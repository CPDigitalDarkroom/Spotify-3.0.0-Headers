...
@interface Mixpanel : NSObject <UIAlertViewDelegate, MPSurveyNavigationControllerDelegate, MPNotificationViewControllerDelegate>
{
    ...
    _Bool _checkForSurveysOnActive;
    _Bool _showSurveyOnActive;
...
@property _Bool showSurveyOnActive; // @synthesize showSurveyOnActive=_showSurveyOnActive;
@property _Bool checkForSurveysOnActive; // @synthesize checkForSurveysOnActive=_checkForSurveysOnActive;
...
- (void)notificationController:(id)arg1 wasDismissedWithStatus:(_Bool)arg2;
...
- (void)markSurvey:(id)arg1 shown:(_Bool)arg2 withAnswerCount:(unsigned long long)arg3;
- (void)showSurveyWithID:(unsigned long long)arg1;
- (void)showSurvey;
- (void)showSurveyWithObject:(id)arg1;
- (void)showSurveyWithObject:(id)arg1 withAlert:(_Bool)arg2;
