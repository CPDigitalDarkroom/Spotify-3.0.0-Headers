...
@property(readonly, nonatomic) unsigned long long buttonIcon; // @synthesize buttonIcon=_buttonIcon;
...
@property(readonly, nonatomic) _Bool alwaysCollapsed; // @synthesize alwaysCollapsed=_alwaysCollapsed;
- (void).cxx_destruct;
