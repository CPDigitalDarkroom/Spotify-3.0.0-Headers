...
@interface SPTLogMessageUIInteraction2 : SPTLogMessage
{
...
+ (id)messageWithRequestId:(id)arg1 featureId:(id)arg2 pageId:(id)arg3 sectionId:(id)arg4 blockIndex:(long long)arg5 itemIndex:(long long)arg6 targetUri:(id)arg7 interactionType:(id)arg8 userIntent:(id)arg9 msSinceEpoch:(double)arg10;
