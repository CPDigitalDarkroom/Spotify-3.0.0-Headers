...
@interface SPTSearchResultsBuilder : NSObject
{
    ...
    unsigned long long _defaultEntityLimitPerSection;
...
@property(readonly, nonatomic) unsigned long long datasetIndex; // @synthesize datasetIndex=_datasetIndex;
@property(readonly, nonatomic) unsigned long long defaultEntityLimitPerSection; // @synthesize defaultEntityLimitPerSection=_defaultEntityLimitPerSection;
...
- (void).cxx_destruct;
- (void)addEntities:(id)arg1 toSectionWithIdentifier:(id)arg2 fromDictionary:(_Bool)arg3;
