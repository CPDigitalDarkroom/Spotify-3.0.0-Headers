...
@class NSArray, NSMutableSet, NSPredicate, NSSortDescriptor, NSString, NSURL, SPTLogCenter, SPTOfflineManager, SPTPodcast, SPTPodcastContextMenuDelegateObject, SPTPodcastSortingService;
...
@property(nonatomic) _Bool loadedFromAnEpisode; // @synthesize loadedFromAnEpisode=_loadedFromAnEpisode;
...
- (_Bool)isFilteredWithFilter:(id)arg1;
...
- (id)initWithPodcastURL:(id)arg1 dataLoader:(id)arg2 player:(id)arg3 podcastCollection:(id)arg4 podcastFeature:(id)arg5 offlineManager:(id)arg6 showEntityService:(id)arg7 sortingService:(id)arg8 logCenter:(id)arg9 featureFlags:(id)arg10;
