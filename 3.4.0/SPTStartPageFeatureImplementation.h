...
@class NSString, SPTAllocationContext, SPTRouter;
...
@property(nonatomic) __weak id <SPTPodcastFollowService> showsFollowService; // @synthesize showsFollowService=_showsFollowService;
...
- (_Bool)calculateIsFeatureEnabled;
