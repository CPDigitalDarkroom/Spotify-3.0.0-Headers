...
+ (id)errorWithSystemAccountStoreDeniedError:(id)arg1 isReauthorize:(_Bool)arg2 forSession:(id)arg3;
...
- (_Bool)areSomeReauthPermissionsGranted:(id)arg1;
...
- (id)logAndReturnErrorForSystemAccountStoreError:(id)arg1 isReauthorize:(_Bool)arg2;
- (void)authorizeUsingSystemAccountStore:(id)arg1 defaultAudience:(unsigned long long)arg2 isReauthorize:(_Bool)arg3;
- (void)authorizeUsingSystemAccountStore:(id)arg1 defaultAudience:(unsigned long long)arg2 isReauthorize:(_Bool)arg3 canFetchAppSettings:(_Bool)arg4;
