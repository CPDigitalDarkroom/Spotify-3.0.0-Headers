...
@protocol SPTBasicImageLoaderCallback <NSObject>
- (void)imageLoaded:(UIImage *)arg1 withDataKey:(id)arg2 forURL:(NSURL *)arg3 startTime:(NSDate *)arg4 forEntity:(NSString *)arg5;
