...
- (id)endpointPathForArtistURL:(id)arg1 type:(unsigned long long)arg2;
- (id)endpointPathForArtistURL:(id)arg1;
- (id)clientEventLoggerForViewURI:(id)arg1;
- (id)viewLoggerForViewURI:(id)arg1;
- (void)preloadAlbumViewData:(unsigned long long)arg1 forArtist:(id)arg2 usingResolver:(id)arg3;
- (void)preloadAlbumViewData:(unsigned long long)arg1 forArtist:(id)arg2;
