...
- (id)indexPathByReplacingFirstIndexIn:(id)arg1 with:(unsigned long long)arg2;
- (long long)numberOfSectionsInDataSource:(id)arg1 inTableView:(id)arg2;
- (id)delegateForIndexPath:(id *)arg1 thatRespondsTo:(SEL)arg2 inTableView:(id)arg3;
- (id)delegateForSection:(long long *)arg1 thatRespondsTo:(SEL)arg2 inTableView:(id)arg3;
- (id)dataSourceForIndexPath:(id *)arg1 thatRespondsTo:(SEL)arg2 inTableView:(id)arg3;
- (id)dataSourceForSection:(long long *)arg1 thatRespondsTo:(SEL)arg2 inTableView:(id)arg3;
- (unsigned long long)indexOfDataSourceForSection:(long long *)arg1 inTableView:(id)arg2;
- (id)allDataSources;
