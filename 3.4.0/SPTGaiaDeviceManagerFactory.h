...
+ (struct SPTGaiaDeviceManagerFactoryProducts)makeGaiaManager:(const struct shared_ptr<spotify::player::ProxyContextPlayer> *)arg1 queue:(const struct shared_ptr<spotify::player::ProxyPlayQueue> *)arg2 pageLoader:(const struct shared_ptr<spotify::player::ContextPageLoader> *)arg3 restorable:(const struct shared_ptr<spotify::player::JsonRestorable> *)arg4 mftRules:(const shared_ptr_1ac160cb *)arg5 session:(id)arg6 productState:(id)arg7 router:(id)arg8 offlineMode:(id)arg9 deviceID:(id)arg10 deviceName:(id)arg11 gaiaEnabled:(_Bool)arg12 isTablet:(_Bool)arg13;
