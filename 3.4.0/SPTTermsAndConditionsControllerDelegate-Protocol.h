...
- (void)termsAndConditionsControllerDidDeferTermsAndConditions:(SPTTermsAndConditionsController *)arg1;
- (_Bool)termsAndConditionsControllerCanDeferAcceptance:(SPTTermsAndConditionsController *)arg1;
@end
