...
- (_Bool)removePersistantURLsNotInArray:(NSArray *)arg1 forKey:(NSString *)arg2 error:(id *)arg3;
- (_Bool)removePersistantURL:(NSURL *)arg1 forKey:(NSString *)arg2 error:(id *)arg3;
