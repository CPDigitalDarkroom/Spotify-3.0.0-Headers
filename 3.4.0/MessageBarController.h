...
- (struct CGRect)frameForCorner:(unsigned long long)arg1 inContentFrame:(struct CGRect)arg2;
- (void)_layoutSubviewsForOrientation:(long long)arg1 messageBarHidden:(_Bool)arg2;
- (struct CGRect)_contentViewFrameWithMessageBarFrame:(struct CGRect)arg1;
- (struct CGRect)_messageBarFrameForOrientation:(long long)arg1 messageBarHidden:(_Bool)arg2;
