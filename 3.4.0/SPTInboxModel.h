...
{
    _Bool _loaded;
    _Bool _previousOfflineState;
    _Bool _loadHasBeenCalled;
...
@property(nonatomic) _Bool loadHasBeenCalled; // @synthesize loadHasBeenCalled=_loadHasBeenCalled;
@property(nonatomic) _Bool previousOfflineState; // @synthesize previousOfflineState=_previousOfflineState;
...
@property(nonatomic) long long numberOfUnreadRows; // @synthesize numberOfUnreadRows=_numberOfUnreadRows;
...
- (unsigned long long)offlineSyncStatusFromOfflineState:(long long)arg1;
- (void)itemDidChange:(id)arg1 context:(id)arg2;
- (id)indexPathForTrackIndex:(long long)arg1;
- (id)playOriginSource;
- (void)observeOfflineState;
- (_Bool)isTrackPlayable:(id)arg1;
...
- (void)markRowSeen:(_Bool)arg1 atIndexPath:(id)arg2;
- (_Bool)playRowAtIndexPath:(id)arg1;
