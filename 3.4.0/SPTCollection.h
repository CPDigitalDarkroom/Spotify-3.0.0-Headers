...
@interface SPTCollection : NSObject <SPCollectionControllerDelegate, SPTCollectionInternal, SPTCollectionOfflining>
{
...
- (_Bool)isAlbumComplete:(id)arg1;
- (_Bool)isFollowedArtist:(id)arg1;
- (_Bool)isEmpty;
- (long long)countOfTracksInCollectionForAlbumLink:(id)arg1;
- (long long)countOfAlbumsInCollectionForArtistLink:(id)arg1;
- (long long)countOfTracksInCollectionForArtistLink:(id)arg1;
