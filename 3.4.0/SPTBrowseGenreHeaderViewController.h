...
{
    _Bool _filterControlASlider;
    _Bool _shouldPlayAudioFeedback;
...
@property(nonatomic) _Bool shouldPlayAudioFeedback; // @synthesize shouldPlayAudioFeedback=_shouldPlayAudioFeedback;
...
@property(readonly, nonatomic, getter=isFilterControlASlider) _Bool filterControlASlider; // @synthesize filterControlASlider=_filterControlASlider;
...
- (void)browseRunningSlider:(id)arg1 didSelectValue:(double)arg2;
...
- (void)applyVolume:(long long)arg1 onAudioUnit:(struct OpaqueAudioComponentInstance *)arg2;
...
- (id)initWithGenreItemDTO:(id)arg1 imageLoader:(id)arg2 options:(unsigned long long)arg3 audioDriverController:(id)arg4;
