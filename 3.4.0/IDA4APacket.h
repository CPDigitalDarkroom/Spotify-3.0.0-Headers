...
+ (_Bool)payloadLength:(unsigned short)arg1 matchesPacketType:(int)arg2;
...
- (id)initWithPacketType:(int)arg1 connectionId:(unsigned long long)arg2 remoteAcceptPort:(unsigned long long)arg3 urgent:(_Bool)arg4 payload:(id)arg5;
- (id)dataWithPacket;
