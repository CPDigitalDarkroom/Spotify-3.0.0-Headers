...
@property(nonatomic) _Bool isBiographyOnTop; // @synthesize isBiographyOnTop=_isBiographyOnTop;
...
- (_Bool)isCurrentlyPlayingTrack:(id)arg1;
...
- (id)dataSourceWithTitle:(id)arg1 viewAllTitle:(id)arg2 forAlbums:(id)arg3 count:(unsigned long long)arg4 type:(unsigned long long)arg5;
- (id)dataSourceWithTitle:(id)arg1 viewAllTitle:(id)arg2 forAlbums:(id)arg3 count:(unsigned long long)arg4 type:(unsigned long long)arg5 asCollectionView:(_Bool)arg6;
...
- (void)pauseAll;
- (void)playContextShuffled:(_Bool)arg1 fromIndex:(id)arg2;
- (void)playContextShuffled:(_Bool)arg1;
...
- (void)viewDidLoad;
- (id)initWithURL:(id)arg1 viewModel:(id)arg2 player:(id)arg3 contextMenu:(id)arg4 session:(id)arg5 offlineManager:(id)arg6 feature:(id)arg7 radioManager:(id)arg8 imageLoaderFactory:(id)arg9 productState:(id)arg10 viewLogger:(id)arg11 clientEventLogger:(id)arg12 audioTouch:(id)arg13 concertFeature:(id)arg14 isBiographyOnTop:(_Bool)arg15;
