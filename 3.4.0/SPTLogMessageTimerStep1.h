...
+ (id)messageWithTimerName:(id)arg1 subdivision:(id)arg2 isFirst:(_Bool)arg3 isLast:(_Bool)arg4 timerStepName:(id)arg5 msSinceEpoch:(long long)arg6 sequenceId:(id)arg7;
