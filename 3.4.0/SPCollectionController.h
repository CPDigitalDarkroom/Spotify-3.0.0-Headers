...
@interface SPCollectionController : NSObject
{
    ...
    struct scoped_ptr<spotify::collection_cosmos::CollectionCosmosHandler> _collectionCosmosHandler;
    NSArray *_artists;
    NSArray *_albums;
...
- (long long)countOfTracksInCollectionForAlbumURL:(id)arg1;
- (long long)countOfAlbumsInCollectionForArtistURL:(id)arg1;
- (long long)countOfTracksInCollectionForArtistURL:(id)arg1;
