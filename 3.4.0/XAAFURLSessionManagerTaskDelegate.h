...
@class NSMutableData, NSProgress, NSString, NSURL, XAAFURLSessionManager;

@interface XAAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    XAAFURLSessionManager *_manager;
...
@property(nonatomic) __weak XAAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
