...
@interface SPTNowPlayingAudioDriverErrorManager : NSObject <SPTAudioDriverControllerObserver, SPTAudioDriverObserver>
{
...
+ (id)nowPlayingAudioDriverErrorManagerWithAudioDriverController:(id)arg1 bannerPresentationManager:(id)arg2;
