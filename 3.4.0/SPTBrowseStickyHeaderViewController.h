...
{
    _Bool _shouldStartWithFirstSubcategory;
...
@property(readonly, nonatomic) _Bool shouldStartWithFirstSubcategory; // @synthesize shouldStartWithFirstSubcategory=_shouldStartWithFirstSubcategory;
- (void).cxx_destruct;
...
- (void)setupView;
- (void)viewDidLoad;
- (void)setupPropertiesWithOptionsMask:(long long)arg1;
