...
- (_Bool)availableWithPlaybackStatus:(SPTExternalPlaybackStatus *)arg1 appLink:(SPTAppLinkController *)arg2;
- (void)triggerCommandWithAppLink:(SPTAppLinkController *)arg1 useVoicePrompts:(_Bool)arg2;
@end
