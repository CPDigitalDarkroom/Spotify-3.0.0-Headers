...
@class FBKVOController, NSMutableDictionary, NSString, SPTDriverDistraction, SPTVideoManifestService, SPTVideoPlaybackSession, SPTVideoPlaybackSessionFactory, SPTVideoSurfaceManagerImpl, SPTWidevineService;
...
- (void)updateCurrentSession:(id)arg1;
- (void)endSession;
- (void)restartSession;
- (void)beginSession:(id)arg1;
- (void)dealloc;
- (id)init;
- (id)initWithResolver:(id)arg1 playbackSessionFactory:(id)arg2 surfaceManager:(id)arg3 manifestService:(id)arg4 widevineService:(id)arg5 driverDistraction:(id)arg6 bannerPresentationManager:(id)arg7;
