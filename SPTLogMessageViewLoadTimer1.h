...
+ (id)messageWithViewName:(id)arg1 subdivision:(id)arg2 isFirst:(BOOL)arg3 isLast:(BOOL)arg4 timerStepName:(id)arg5 msSinceEpoch:(long long)arg6 sequenceId:(id)arg7;
